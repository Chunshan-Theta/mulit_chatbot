...
channel_secret = os.getenv('LINE_CHANNEL_SECRET', "94e92187579a5377d59c0b936c54625f")
channel_access_token = os.getenv('LINE_CHANNEL_ACCESS_TOKEN', "5a4198d6-853a-4a74-9d1e-385db31b4939")
